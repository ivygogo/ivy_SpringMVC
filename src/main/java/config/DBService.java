...
public class DBService {
  ...
  private static final String DROP_BookCompany_SQLServer =
      "IF OBJECT_ID('dbo.BookCompany', 'U') IS NOT NULL " + " DROP TABLE dbo.BookCompany; ";
  ...
  private static final String CREATE_OrderItems_MySQL =
  ...
  private static final String CREATE_OrderItems_SQLServer =
      "Create TABLE OrderItems "
  ...
  private static final String CREATE_Orders_MySQL =
      "Create Table Orders "
  ...
  private static final String CREATE_Orders_SQLServer =
      "Create Table Orders "
  ...
  private static final String CREATE_BookCompany_SQLServer =
      "CREATE TABLE BookCompany "
  ...
  private static final String CREATE_Book_MySQL =
      " CREATE TABLE Book "
  ...
  private static final String CREATE_Book_SQLServer =
      "CREATE TABLE Book "
  ...
  private static final String CREATE_Member_MySQL =
      " CREATE TABLE Member "
  ...
  private static final String CREATE_Member_SQLServer =
      " CREATE TABLE Member "
